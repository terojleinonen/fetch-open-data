import rawRoles from "@/data/character-roles.json";
import {
  characterResearch,
  characterWorks,
  characters,
...
export default function Antagonists() {
  const ids = new Set(
      rawRoles
        .filter((role) => role.role === "antagonist")
    ...
    <main className="evil-page">
      ...
      <section className="evil-spectrum">
        <div>
          ...
          <p>
            The source data identifies antagonistic roles. Human, supernatural
            and cosmic classifications remain editorial questions until
      ...
      <section className="rogue-gallery">
        <header>
          ...
          <p>One line per record. One active file under examination.</p>
        </header>
